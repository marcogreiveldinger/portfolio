...
function HomeSection(): ReactElement {
  return (
    <section id="home" className="flex items-center py-16 ">
      <div className="w-1/2">
        <h1 className="text-6xl  font-bold mb-8">Marco Greiveldinger</h1>
        ...
        <div className="flex space-x-4 mt-4">
          ...
          >
            <button
              type="button"
              className="bg-transparent rounded-full hover:bg-pink-500 active:bg-pink-600 font-bold uppercase px-8 py-3 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            >
              <FontAwesomeIcon
                icon={faGithub}
